...
AddonID = 'plugin.video.cantinhox'
...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.cantinhox/data" ).decode("utf-8"), AddonID)
...
def Categories():
	...
	for item in list:
		...
		AddDir("[COLOR red][{0}][/COLOR]".format(name) ,item["url"].encode("utf-8"), mode, image.encode("utf-8"), logos.encode("utf-8"), index=i)
		i += 1
