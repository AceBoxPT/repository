...
class source:
    def __init__(self):
        self.domains = ['tugaflix.top', 'openload.co']
        self.base_link = 'https://tugaflix.com'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            for i in links: sources.append({'source': 'openload', 'quality': i[1], 'provider': 'Tugaflixcom', 'url': i[0], 'direct': True, 'debridonly': False})
