...
if action == None:
    ...
    if yes:
		try: 
			...
			dialog.ok('Apagar progresso','Apagar progresso Completo','','')
		except:
			dialog.ok('Apagar progresso','Aconteceu um erro ao apagar a base de dados','','')		
    ...
    from resources.lib.modules import control
    dialog = xbmcgui.Dialog()
    USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.apocalypse',''))
