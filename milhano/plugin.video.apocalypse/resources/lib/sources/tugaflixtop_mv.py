...
class source:
    def __init__(self):
        self.domains = ['tugaflix.com', 'xmovies8.org', 'openload.co']
        self.base_link = 'https://tugaflix.top'
        self.search_link = '/Filmes?T=&G=&O=1'
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            for i in links: sources.append({'source': 'openload', 'quality': i[1], 'provider': 'Tugaflixtop', 'url': i[0], 'direct': True, 'debridonly': False})
