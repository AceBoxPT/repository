...
class source:
    def __init__(self):
        testurl = "http://tugaflix.com/"
        self.base_link = 'http://tugaflix.top/'
        self.social_lock = ''
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            for i in r:
                try: sources.append({'source': 'gvideo', 'quality': directstream.googletag(i)[0]['quality'], 'provider': 'tugaflixtop', 'url': i, 'direct': True, 'debridonly': False})
                except: pass
